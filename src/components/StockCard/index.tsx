...
export default function StockCard({
  ...
  return (
    <article
      ...
      className={`relative m-6 p-6 rounded-2xl shadow-md shadow-accent-3 text-content bg-accent-2 transition-all hover:scale-x-[1.02] md:hover:scale-x-[1.01] hover:shadow-lg hover:shadow-accent-1`}
    >
