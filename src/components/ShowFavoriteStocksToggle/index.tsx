...
export default function ShowFavoriteStocksToggle({
  ...
  return (
    <button
      ...
      className="transition hover:scale-x-105 bg-accent-1 hover:bg-accent-2 active:bg-accent-3 shadow-sm shadow-accent-1 hover:shadow-md hover:shadow-accent-1 active:shadow-none rounded-md py-2 px-4 mx-4"
